...
<h1 style="text-align:center">본인이 호스팅한 숙소는 예약할 수 없습니다.</h1><br>
...
<table id="list">
	...
	<tr>
		...
		<td><a href="${context}/book.do?action=find_by_list&page=book&keyword=${city.address}">${city.explain}</a></td>
	    <td>${city.address}</td>
