...
<jsp:include page="${context}/WEB-INF/global/top.jsp"/>
<jsp:include page="${context}/WEB-INF/global/header.jsp"/>
<div class="box">
	<form action="${context}/WEB-INF/result/regist_result.jsp" method="post">
...
<jsp:include page="${context}/WEB-INF/global/footer.jsp"/>
<jsp:include page="${context}/WEB-INF/global/end.jsp"/>