...
+'<input type="text" placeholder="부터" style="text-align:right;" />'
+'</label>'
+'<label class="col-md-4 col-sm-6 space-1" style="display : inline;">'
+'<input type="text" placeholder="까지" style="text-align:right;" />'
+'</label>'
+'<div>'
+'</div>'	
+'</div>'
...
+'</div>'
+'<div class="col-md-4">'
+'<div><input name="fac_option" type="checkbox" value="집에서 키우는 반려동물">집에서 키우는 반려동물</div>'
+'</div>'
+'<div class="col-md-4">'
+'<div><input name="fac_option" type="checkbox" value="도어맨">도어맨</div>'
+'</div>'
+'<div class="col-md-4">'
+'<div><input name="fac_option" type="checkbox" value="무료 헬스장">무료 헬스장</div>'
+'</div>'
+'<div class="col-md-4">'
+'<div><input name="fac_option" type="checkbox" value="무료주차 포함">무료주차 포함</div>'
+'</div>'
+'<div class="col-md-4">'
