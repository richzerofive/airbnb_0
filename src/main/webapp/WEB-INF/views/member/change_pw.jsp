...
<ul class="sidenav-list">
  ...
  <li>
    <a href="#" aria-selected="false" class="sidenav-item" id="change-pw">Change Password</a>
  </li>


  <li>
    <a href="#" aria-selected="false" class="sidenav-item" id="remove-account">Remove Account</a>
  </li>
    ...
    <div id="cancel-account-form" class="hide">
      <div class="row">
        <div class="col-7">
          ...
          <form accept-charset="UTF-8" action="https://www.airbnb.com/users/delete/27430889" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="✓"><input name="authenticity_token" type="hidden" value="V4$.airbnb.com$9wwyQAJLmoI$ucQR1DlWEWTg-FuOJGHof5_ja_wE0FV8V9ooMKgRAhY="></div>
            <div class="space-2">
