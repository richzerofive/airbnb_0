	...
	<div class="guidebook-form__recommendations-container">
		<div class="guidebook-form__head">
			<div class="panel-body">
				<h2>
					<span>회원님이#도시이름#에서 좋아하는 것들을 소개해 주세요.</span>
				</h2>
				...
				<div class="guidebook-form__sub-head-legal">
					<a href="#" target="_blank"><span><span>가이드북 인쇄하기
				...
				<div class="recommendation-form__add-section">
					<div class="panel-body">
						<div class="row row-condensed">
							<div class="col-md-1">
								<div
									class="recommendation-form__icon text-white icon h4 text-center gb-icon-food-scene"></div>
							</div>
							<div class="col-md-8">
								<h3>음식</h3>
								...
								<div class="col-md-8">
									<div class="recommendation-form__section">
										<div class="location-autocomplete">
											<i
												class="icon icon-search h3 location-autocomplete__eyeglass"></i>
											<input type="text" value="" placeholder="추천 장소..."
												autocomplete="off">
										</div>
									</div>
									<div>
										<div class="recommendation-form__section">
											<div class="row row-condensed">
												<div class="col-md-12">
													<div class="select">
														<select><option value="-1">카테고리 선택</option>
															<option>레스토랑</option>
				...
				<div class="recommendation-form__add-section">
					<div class="panel-body">
						<div class="row row-condensed">
							<div class="col-md-1">
								<div
									class="recommendation-form__icon text-white icon h4 text-center gb-icon-sightseeing"></div>
							</div>
							<div class="col-md-8">
								<h3>관광</h3>
								<hr class="recommendation-form__mini-hr">
				...
				<div class="recommendation-form__add-section">
					<div class="panel-body">
						<div class="row row-condensed">
							<div class="col-md-1">
								<div
									class="recommendation-form__icon text-white icon h4 text-center gb-icon-parks-nature"></div>
							</div>
							<div class="col-md-8">
								<h3>공원 및 자연</h3>
								<hr class="recommendation-form__mini-hr">
				...
				<div class="recommendation-form__add-section">
					<div class="panel-body">
						<div class="row row-condensed">
							<div class="col-md-1">
								<div
									class="recommendation-form__icon text-white icon h4 text-center gb-icon-arts-culture"></div>
							</div>
							<div class="col-md-8">
								<h3>예술과 문화</h3>
								<hr class="recommendation-form__mini-hr">
				...
				<div class="recommendation-form__add-section">
					<div class="panel-body">
						<div class="row row-condensed">
							<div class="col-md-1">
								<div
									class="recommendation-form__icon text-white icon h4 text-center gb-icon-shopping"></div>
							</div>
							<div class="col-md-8">
								<h3>쇼핑</h3>
								<hr class="recommendation-form__mini-hr">
				...
				<div class="recommendation-form__add-section">
					<div class="panel-body">
						<div class="row row-condensed">
							<div class="col-md-1">
								<div
									class="recommendation-form__icon text-white icon h4 text-center gb-icon-essentials"></div>
							</div>
							<div class="col-md-8">
								<h3>생활 필수 서비스</h3>
								<hr class="recommendation-form__mini-hr">
				...
				<div class="recommendation-form__add-section">
					<div class="panel-body">
						<div class="row row-condensed">
							<div class="col-md-1">
								<div
									class="recommendation-form__icon text-white icon h4 text-center gb-icon-entertainment"></div>
							</div>
							<div class="col-md-8">
								<h3>엔터테인먼트와 액티비티</h3>
								<hr class="recommendation-form__mini-hr">
				...
				<div class="recommendation-form__add-section">
					<div class="panel-body">
						<div class="row row-condensed">
							<div class="col-md-1">
								<div
									class="recommendation-form__icon text-white icon h4 text-center gb-icon-getting-around"></div>
							</div>
							<div class="col-md-8">
								<h3>교통편</h3>
								<hr class="recommendation-form__mini-hr">
				...
				<div class="recommendation-form__add-section">
					<div class="panel-body">
						<div class="row row-condensed">
							<div class="col-md-1">
								<div
									class="recommendation-form__icon text-white icon h4 text-center gb-icon-everything-else"></div>
							</div>
							<div class="col-md-8">
								<h3>기타</h3>
								<hr class="recommendation-form__mini-hr">
